...
function agregarProducto1() {
  agregarProducto(129000, 'Escritorio para oficina gris', 'https://www.mueblescaracol.cl/productos/oficina1.png', 129000);
}

function agregarProducto2() {
  agregarProducto(129000, 'Escritorio para oficina blanco', 'https://www.mueblescaracol.cl/productos/oficina2.png', 129000);
}
