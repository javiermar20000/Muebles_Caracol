...
function agregarProducto1() {
  agregarProducto(130000, 'Marquesa 1 y 1/2 plaza nogal', 'https://www.mueblescaracol.cl/productos/marquesa1.png', 130000);
}

function agregarProducto2() {
  agregarProducto(135000, 'Marquesa 1 y 1/2 plaza nogal y tapizada', 'https://www.mueblescaracol.cl/productos/marquesa2xd.png', 135000);
}

function agregarProducto3() {
  agregarProducto(150000, "Marquesa 2 plazas natural", "https://www.mueblescaracol.cl/productos/marquesa3xd.png", 150000);
}

function agregarProducto4() {
  agregarProducto(160000, "Marquesa 2 plazas natural tapizada", "https://www.mueblescaracol.cl/productos/marquesa4xd.png", 160000);
}

function agregarProducto5() {
  agregarProducto(195000, "Closet 4 cuerpos bi-color", "https://www.mueblescaracol.cl/productos/dor1.jpeg", 195000);
}

function agregarProducto6() {
  agregarProducto(195000, "Closet 4 cuerpos bi-color oscuro", "https://www.mueblescaracol.cl/productos/dor2.jpeg", 195000);
}

function agregarProducto7() {
  agregarProducto(160000, "Closet 2 cuerpos nogal", "https://www.mueblescaracol.cl/productos/dor3.jpeg", 160000);
}

function agregarProducto8() {
  agregarProducto(159000, "Closet de 2 cuerpos chocolate", "https://www.mueblescaracol.cl/productos/dor4.jpeg", 159000);
}

function agregarProducto9() {
  agregarProducto(109000, "Comoda melamina 4 cajones", "https://www.mueblescaracol.cl/productos/dor5.jpeg", 109000);
}

function agregarProducto10() {
  agregarProducto(155000, "Comoda melamina 6 cajones", "https://www.mueblescaracol.cl/productos/dor6.jpeg", 155000);
}

function agregarProducto11() {
  agregarProducto(139000, "Comoda nogal 6 cajones", "https://www.mueblescaracol.cl/productos/dor7.jpeg", 139000);
}

function agregarProducto12() {
  agregarProducto(159000, "Tocador Mujer dormitorio", "https://www.mueblescaracol.cl/productos/dor8.jpeg", 159000);
}

function agregarProducto13() {
  agregarProducto(49000, "Velador cerezoo", "https://www.mueblescaracol.cl/productos/dor9.jpeg", 49000);
}

function agregarProducto14() {
  agregarProducto(60000, "Velador chocolate", "https://www.mueblescaracol.cl/productos/dor10.jpeg", 60000);
}

function agregarProducto15() {
  agregarProducto(210000, "Comoda 8 cajones chocolate", "https://www.mueblescaracol.cl/productos/dor12.jpeg", 210000);
}
