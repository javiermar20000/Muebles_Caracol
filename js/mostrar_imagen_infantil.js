...
function agregarProducto1() {
  agregarProducto(120000, 'Comoda Infantil blanca', 'https://www.mueblescaracol.cl/productos/foto_infantil1.jpeg', 120000);
}

function agregarProducto2() {
  agregarProducto(155000, 'Comoda Infantil azul y blanca', 'https://www.mueblescaracol.cl/productos/foto_infantil2.png', 155000);
}

function agregarProducto3() {
  agregarProducto(169000, "Comoda closet infantil rosada blanca", "https://www.mueblescaracol.cl/productos/foto_infantil3.jpeg", 169000);
}

function agregarProducto4() {
  agregarProducto(150000, "Comoda blanca con decoración", "https://www.mueblescaracol.cl/productos/foto_infantil4.jpeg", 150000);
}

function agregarProducto5() {
  agregarProducto(160000, "Closet infantil 2 cuerpos bi-color", "https://www.mueblescaracol.cl/productos/foto_infantil5.jpeg", 160000);
}
