...
function agregarProducto1() {
  agregarProducto(330000, 'Living seccional gris', 'https://www.mueblescaracol.cl/productos/foto_living.jpeg', 330000);
}

function agregarProducto2() {
  agregarProducto(480000, 'Living seccional rojo', 'https://www.mueblescaracol.cl/productos/foto_living1.jpeg', 480000);
}

function agregarProducto3() {
  agregarProducto(330000, "Living seccional amarillo", "https://www.mueblescaracol.cl/productos/foto_living2.jpeg", 330000);
}

function agregarProducto4() {
  agregarProducto(530000, "Living seccional rojo carmesi", "https://www.mueblescaracol.cl/productos/foto_living3.jpeg", 530000);
}

function agregarProducto5() {
  agregarProducto(390000, "Living seccional rojo con negro", "https://www.mueblescaracol.cl/productos/foto_living4.jpeg", 390000);
}
