...
function agregarProducto1() {
  agregarProducto(450000, 'Comedor de madera nogal con 6 sillas', 'https://www.mueblescaracol.cl/productos/foto_comedor.jpeg', 450000);
}

function agregarProducto2() {
  agregarProducto(450000, 'Comedor madera cerezo, con 6 sillas', 'https://www.mueblescaracol.cl/productos/foto_comedor1.jpeg', 450000);
}

function agregarProducto3() {
  agregarProducto(450000, "Comedor madera cerezo con 6 sillas", "https://www.mueblescaracol.cl/productos/foto_comedor2.jpeg", 450000);
}

function agregarProducto4() {
  agregarProducto(320000, "Comedor metal madera con 6 sillas", "https://www.mueblescaracol.cl/productos/foto_comedor3.jpeg", 320000);
}
