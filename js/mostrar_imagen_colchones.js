...
function agregarProducto1() {
  agregarProducto(80000, 'Colchon espuma 1 plaza', 'https://www.mueblescaracol.cl/productos/colchones1.png', 80000);
}

function agregarProducto2() {
  agregarProducto(95000, 'Colchon espuma 1 y 1/2 plaza', 'https://www.mueblescaracol.cl/productos/colchones2.png', 95000);
}

function agregarProducto3() {
  agregarProducto(150000, "Colchon espuma 2 plazas", "https://www.mueblescaracol.cl/productos/colchones3.png", 150000);
}

function agregarProducto4() {
  agregarProducto(109000, "Colchon resorte 1 plaza", "https://www.mueblescaracol.cl/productos/colchones4.jpeg", 109000);
}

function agregarProducto5() {
  agregarProducto(109000, "Colchon resorte, 1 plaza", "https://www.mueblescaracol.cl/productos/colchones5.jpeg", 109000);
}

function agregarProducto6() {
  agregarProducto(139000, "Colchon resorte 1 y 1/2 plazas", "https://www.mueblescaracol.cl/productos/colchones6.jpeg", 139000);
}

function agregarProducto7() {
  agregarProducto(189000, "Colchon resorte 2 plazas", "https://www.mueblescaracol.cl/productos/colchones7.jpeg", 189000);
}
