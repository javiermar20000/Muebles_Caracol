...
function agregarProducto1() {
  agregarProducto(150000, 'Base de cocina 3 cuerpos con cajon - melamina', 'https://www.mueblescaracol.cl/productos/cocina1.jpeg', 150000);
}

function agregarProducto2() {
  agregarProducto(75000, 'Base de cocina 2 cuerpos con verdulero', 'https://www.mueblescaracol.cl/productos/cocina2.jpeg', 75000);
}

function agregarProducto3() {
  agregarProducto(139000, "Lavaplatos blanco melamina, de 1 metro, con cajon", "https://www.mueblescaracol.cl/productos/cocina3.jpeg", 139000);
}

function agregarProducto4() {
  agregarProducto(150000, "Base de cocina 3 cuerpos con cajon, melamina", "https://www.mueblescaracol.cl/productos/cocina4.jpeg", 150000);
}

function agregarProducto5() {
  agregarProducto(150000, "Base de cocina 3 cuerpos con cajon, de melamina", "https://www.mueblescaracol.cl/productos/cocina5.jpeg", 150000);
}
